...
boost::shared_ptr<double> TriGaussIntegral(
  ...
  auto t1 = point_3(1) - point_2(1);
  matrix_p(0, 0) = t1;
  auto t2 = point_2(0) - point_3(0);
  matrix_p(0, 1) = t2;
  auto t3 = point_1(1) - point_3(1);
  matrix_p(1, 0) = t3;
  auto t4 = point_3(0) - point_1(0);
  matrix_p(1, 1) = t4;
  // 生成Q向量(Q向量参考理论推导草稿)
  Eigen::Vector2d vector_q;
  vector_q(0) = point_2(0) * point_3(1) - point_2(1) * point_3(0);
